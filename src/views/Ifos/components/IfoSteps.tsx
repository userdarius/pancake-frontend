...
import { Stepper, Step, StepStatus, Card, CardBody, Heading, Text, Button, Link, OpenNewIcon } from '@xnorandom/cryptogenicuikitmod'
        ...
        return (
          <CardBody>
            ...
            <Button
              as={Link}
              external
              href={`${BASE_ADD_LIQUIDITY_URL}/BNB/0x0eb1bc7161424fa5ec42319d32b9e98e7b667410`}
